...
|3rd Party API - Group Games|`https://raw.githubusercontent.com/openfootball/world-cup.json/master/2018/worldcup.standings.json`|Get all World Cup Games Results JSON
